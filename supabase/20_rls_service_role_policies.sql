...
--  Chiude gli alert "RLS enabled no policy" senza aprire
--  accessi ai client anon/auth: le API server continuano a
--  usare service role, quindi questa policy e solo dichiarativa.
-- ============================================================
